...
export default function MarketplacePage() {
	...
	const visible=useMemo(()=>listings.filter((listing)=>{
		...
		return matchesFilter&&(!query||[listing.title,listing.asset.title,listing.asset.reference,listing.seller.reference,listing.seller.name].some((value)=>String(value||'').toLowerCase().includes(query)));
